      ...
      <div class="leftdivcontainer clearfix">
        <div class="leftdiv">
          <div style="border: 2px solid #287729; border-radius: 7px; text-align: left; width: 60%; padding: 10px;">
            <span style="color: #000; font-weight: bold; font-size: 15px; letter-spacing: 1px;">asdd</span>
          </div>
        </div>
        <div class="leftdiv" style="margin-top: 0;">
          <div style="color: #000; font-size: 22px; font-weight: bold; text-decoration: underline;">LISTA GENERAL DE TRÁMITES POR AGENCIA</div>
        </div>
        <div class="leftdiv">
